...
import { Loader2, Menu, RefreshCw, Plus } from "lucide-react";
          ...
          <Card className="bg-white border-zinc-200">
            <CardHeader>
              ...
              <CardDescription className="text-zinc-600">
                This page is under development. API key management features will
                be available soon.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <RefreshCw className="w-16 h-16 text-zinc-400 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-zinc-900 mb-2">
                  Coming Soon
                </h3>
                <p className="text-zinc-600">
                  API key management functionality is being developed and will
