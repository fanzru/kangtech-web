...
import { Loader2, Menu, FileText, Plus } from "lucide-react";
      ...
      <div className="flex-1 lg:ml-64">
        ...
        <main className="p-6">
          <Card className="bg-white border-zinc-200">
            <CardHeader>
              <CardTitle className="text-zinc-900">Blog Posts</CardTitle>
              <CardDescription className="text-zinc-600">
                This page is under development. Blog management features will be
                available soon.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-zinc-600">
                  Blog management functionality is being developed and will be
